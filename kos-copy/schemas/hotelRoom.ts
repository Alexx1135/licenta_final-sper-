...
const roomTypes = [
  { title: 'Double Room', value: 'double_room' },
  { title: 'Petite Family', value: 'petite_family' },
  { title: 'Bungalow Maisonette', value: 'bungalow_maisonette' },
  { title: 'Single Room', value: 'single_room' },
  { title: 'Luxury Family Suite', value: 'luxury_family_suite' },
];
